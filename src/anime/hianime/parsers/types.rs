use crate::anime::hianime::types::{
    ...
    LatestEpisodeAnime, MostFavoriteAnime, MostPopularAnime, QtipAnime, RawEpisode, SpotlightAnime,
    SubEpisode, Top10AnimesWithPeriod, TopAiringAnime, TopUpcomingAnime, TrendingAnime,
};
